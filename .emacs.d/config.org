...
#+BEGIN_SRC emacs-lisp
  (load "~/.emacs.d/plugins/rtags/src/rtags")
  (cmake-ide-setup)
  ...
  (use-package rtags
    ...
    :config (setq rtags-completions-enabled t
                  rtags-path "~/.emacs.d/plugins/rtags/src/rtags.el"
                  rtags-rc-binary-name "~/.emacs.d/plugins/rtags/bin/rc"
                  rtags-use-ivy t
                  rtags-rdm-binary-name "~/.emacs.d/plugins/rtags/bin/rdm"))
